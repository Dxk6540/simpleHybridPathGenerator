...
%             mParam.stepOver = 0.1;
        ...
        ret = genNormalMachiningProcess(obj, pg, mPathSeq, mFeedrate, side, machiningParam);
        ...
        ret = genRollerPrintingProcess(obj, pg, safetyHeight, pPathSeq, pwrSeq, pFeedrate, printParam);
    end
end