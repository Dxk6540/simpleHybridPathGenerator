...
masPath=[];
for i=1:pLyrNum
    [pPathSeq,pwrSeq,feedOffset] = handle.genPrintingPath(cubeShape, startCtr, 1, lyrHeight, round(max(100,(1-0.2/pLyrNum*i)*aupwr)), zOffset+(i-1)*lyrHeight, angle(rem(floor(i-1),length(angle))+1), false, step, 0, 0);
