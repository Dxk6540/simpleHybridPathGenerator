...
filename = strcat('./claddingTest_',date,'.NC');
...
hProc.sProcessParam_.safetyHeight=100;%%%%%%%%%%%%%;%% Safety heightï¼? Attention

%  geometry param
% startCtr = [0,0]; % left bottom corner

% inclinationAgl = 0; % degree
lyrHeight=1;%% Layer height
...
step = 0.7;%%%% s: the interval between two channels
channel=ceil(y_length/step)+1;
cubeShape = [x_length+4,channel];
handle=zigzagPathCube;
hProc.sPrintParam_.pFeedrate = 700;%%%%%
hProc.sPrintParam_.pwr=225;%%%%%³ýÒÔ4
