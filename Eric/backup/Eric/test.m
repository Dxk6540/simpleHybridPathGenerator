...
pg.changeMode(1);
[pPathSeq, pwrSeq, feedOffset] = handle.genPrintingPath(wallLength, startCtr, 0.1, pLyrNum, lyrHeight, pwr, zOffset, channel, step);
...
[mPathSeq, mFeedrateSeq] = handle.genMachiningPath(wallLength, wallWidth, 0.1, startCtr, mFeedrate, traversalSpeed, toolRadiu, wallOffset, depth, zOffset);
